...
function getPriority(description) {
    const highPriorityKeywords = ['urgent', 'immediate', 'critical', 'failure', 'emergency'];
    const mediumPriorityKeywords = ['important', 'moderate', 'attention', 'issue'];
...
// Example usage
const priority = getPriority('System failure detected in the production environment');
